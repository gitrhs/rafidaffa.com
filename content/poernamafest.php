...
<div class="d-flex justify-content-center">
    <div class="content">
        ...
        <p class="about-section">PoernamaFest is an annual cultural festival that celebrates the beauty and diversity of
            ...
            everyone to learn, share, and enjoy. Performers from different countries, including Malaysia, honor
            Indonesian culture by singing Indonesian songs, making the event a unique and memorable experience for all.
        </p>
        <div class="info">
            <div class="label">Role:</div>
            <div class="value">Full-Stack Developer and UI/UX Designer</div>
            <div class="label">Timeline:</div>
            <div class="value">October 2023 - November 2023</div>
            <div class="label">Purpose:</div>
            <div class="value">Make it easier for people to learn about and participate in the festival</div>
            <div class="label">Result:</div>
            <div class="value">Increase ticket sales and strengthen brand identity</div>
        </div><br>
        <a href="https://poernamafest.rafidaffa.com" target="_blank" type="button"
