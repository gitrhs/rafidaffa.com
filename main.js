    ...
    if (map.has(data_id)) {
        ...
        fetch(`../content/${data_id}.php`)
            ...
            .then((data) => {
                ...
                switch (data_id) {
                    case "home":
                        loadScript("../js/home.js?dev=3.3.3", () => {
                            homefunc();
                        });
                        break;
                    case "course":
                        loadScript("../js/course.js?dev=3.3.3", () => {
                            coursefunc();
                        });
                        break;
                    case "contact":
                        loadScript("../js/contact.js?dev=3.3.3", () => {
                            contactfunc();
                        });
                        break;
                    case "blog":
                        loadScript("../js/blog.js?dev=3.3.3", () => {
                            blogfunc();
                        });
                        break;
                    case "wotp":
                        loadScript("../js/project.js?dev=3.3.3", () => {
                            projectfunc();
                        });
                        break;
                    case "avatarai":
